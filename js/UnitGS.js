...
*	
*  Being adapted to the Unit Grid System. :D
*/
...
var baseFontSize = 16;
var baseFontLineGridHeightRatio = 1.5;
var baselineGridHeight = ((16 * baseFontLineGridHeightRatio) / baseFontSize) + 'em';

var twelveColBreakpoint = ((720-1) / baseFontSize)+'em';
var twentyfourColBreakpoint = ((1872-1) / baseFontSize)+'em';
...
/*  Create CSS */
    var styles = '\
        ...
        .ggs-guide{position:absolute;top:0;z-index:9000;height:100%;margin-left:-0.6em;border:solid '+guideColor+';border-width:0 0.6em;background:'+guideColor+';opacity:'+guideOpacity+'; -webkit-transition: all 0.235s ease-out; -moz-transition: all 0.235s ease-out; -ms-transition: all 0.235s ease-out; transition: all 0.235s ease-out;}\
        ...
        .ggs-23{left:94%;}\
        .ggs-24{right:0;}\
        .ggs-0,.ggs-24{width:2%;padding-right:0.6em;border:0;margin:0;}\
        .ggs-guide div{background:'+guideInnerColor+';width:2px;height:100%;position:absolute;left:-1px;top:0;}\
        .ggs-0 div{left:auto;right:0.6em;}\
        .ggs-24 div{left:0.6em;}\
        ...
        @media screen and (max-width: ' + (twelveColBreakpoint) + '){.ggs-2,.ggs-6,.ggs-10,.ggs-14,.ggs-18,.ggs-22{display:none;}}\
        @media screen and (max-width: ' + (twentyfourColBreakpoint) + '){.ggs-1,.ggs-3,.ggs-5,.ggs-7,.ggs-9,.ggs-11,.ggs-13,.ggs-15,.ggs-17,.ggs-19,.ggs-21,.ggs-23{display:none;}}\
    ';	
